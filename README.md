...
| Entrega | Enlace |
|---------|--------|
| Código fuente | este repo (GitHub) |
| Instalación paso a paso | [este README](#instalación-completa-local--wsl) + [INSTALACION.md](INSTALACION.md) |
| Checklist de entrega / cierre | [ENTREGA.md](ENTREGA.md) |
| SQL Supabase | [supabase/schema.sql](supabase/schema.sql) |
